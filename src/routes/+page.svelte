<script lang="ts">
  ...
  let Monaco;
  let code = ['finder = AStarFinder(diagonal_movement=DiagonalMovement.always)',
...
<div class="fabs" role="group" aria-label="Floating action buttons">
  <button on:click={() => {console.log(editor.getValue())}} class="fab" title="Run code" aria-label="Run code">
